...
public class ImportRelationshipsFromGDELTPlugin extends RecordStoreQueryPlugin implements DataAccessPlugin {
    ...
    public static final String LOCAL_DATE_PARAMETER_ID = PluginParameter.buildId(ImportRelationshipsFromGDELTPlugin.class, "local_date");
    ...
    protected RecordStore query(final RecordStore query, final PluginInteraction interaction, final PluginParameters parameters) throws InterruptedException, PluginException {
        ...
        if (localDate != null) {            
            try {
                results = GDELTImportingUtilities.retrieveRelationships(localDate, options, limit);
